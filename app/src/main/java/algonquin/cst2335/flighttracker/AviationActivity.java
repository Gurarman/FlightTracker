...
import algonquin.cst2335.flighttracker.Adapters.FlightAdapter;
import algonquin.cst2335.flighttracker.FlightData.FlightDatabase;
import algonquin.cst2335.flighttracker.FlightData.FlightDetails;
...
public class AviationActivity extends AppCompatActivity {
    ...
    public void getFlightsFromApi(String airportCode) {
        String url = "http://api.aviationstack.com/v1/flights?access_key=61bf0b21e8d80ae0bb956462e40669a1&dep_iata=" + airportCode;
